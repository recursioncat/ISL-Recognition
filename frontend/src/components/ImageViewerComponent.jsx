...
const ImageViewerComponent = ({ imageUrl, videoUrl, senderName, type , setIsViewerVisible }) => {
  
  console.log('imageUrl', imageUrl , 'videoUrl', videoUrl, 'senderName', senderName, 'type', type);
  ...
  useEffect(() => {
    ...
    return () => {
      // Restore header visibility when the component is unmounted
  ...
  const handleBackPress = () => {
    setIsViewerVisible(false); // Close the ImageViewer on back press
  };
